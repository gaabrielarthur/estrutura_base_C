...
#include <fstream> // biblioteca para  utilizar arquivos
#include <stdbool.h>
#include <string.h> // biblioteca para  utilizar caracateres
#include <iostream>
#include <new> // biblioteca para usar alocação dinamica
using namespace std;
